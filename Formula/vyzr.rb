class Vyzr < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.10.3/vyzr-darwin-arm64"
      sha256 "ab94778ce63ab819a73462e67b0d118ec51849133892eb46838d28c0fd070c97"
    end
    on_intel do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.10.3/vyzr-darwin-x64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.10.3/vyzr-linux-x64"
      sha256 "c08bfd00ca27b7a0a66345140bb1ec9239a678cca50ea9a71f80adbc2ef3bb29"
    end
    on_arm do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.10.3/vyzr-linux-arm64"
