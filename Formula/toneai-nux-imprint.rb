...
class ToneaiNuxImprint < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/cordfuse/toneai-nux-imprint/releases/download/v1.6.0/toneai-nux-imprint-mac-arm64"
      sha256 "13e7439ebc2632715b30e45b60552c8070ceabd6feb666382072a70a69605ac9"
    end
    on_intel do
      url "https://github.com/cordfuse/toneai-nux-imprint/releases/download/v1.6.0/toneai-nux-imprint-mac-x64"
